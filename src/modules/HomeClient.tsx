...
export default function HomeClient() {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center flex-col justify-between p-4 selection:bg-offBlue selection:text-lightYellow">
      <header className="relative w-full h-fit items-center justify-center sm:justify-between gap-3 flex flex-row text-xl font-york flex-wrap text-center">
        <div
      ...
      <article className="relative w-full h-fit flex flex-col app:flex-row justify-between items-center sm:gap-0 gap-5">
        ...
        <div className="relative w-full h-fit flex flex-col items-center justify-center">
          ...
          <div className="relative w-fit h-fit flex">
            <video
              ...
              aria-label="F3Manifesto & The Machines - I WANT MY WEB3 FASHION video by Emma-Jane MacKinnon-Lee"
              title="F3Manifesto & The Machines - Web3 Fashion video by Emma-Jane MacKinnon-Lee"
            >
              <source src="/videos/f3m.mp4" type="video/mp4" />
            </video>
          </div>
          <div className="font-air text-sm w-fit h-fit relative text-center">
            EST. 2021
      ...
      <footer className="relative w-full h-fit items-center sm:items-end justify-center sm:justify-between gap-3 flex flex-col sm:flex-row font-york">
        ...
        <div className="relative text-center sm:text-right flex h-fit text-xs font-din w-fit sm:w-44 flex-col items-center justify-center sm:items-end sm:justify-end">
          ...
          <address className="relative w-fit h-fit flex not-italic">
            <a
              href="https://emmajanemackinnonlee.com/"
              rel="author"
              className="underline cursor-empireS"
            >
